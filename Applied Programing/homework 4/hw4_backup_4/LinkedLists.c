...
void InitLinkedList(LinkedLists *ListPtr)
{
	...
	/*ListPtr = (LinkedLists *)malloc(sizeof(LinkedLists));
	if (ListPtr == NULL){
		fprintf(stderr, "Malloc for ListPtr FAILED!\n");
		fprintf(stderr, "LinkedList.c, InitLinkedLists, Line ...\n");
		fflush(stderr);
	}
	*/
...
/*--------Creating Temp Variables, node, and alocation Memeory--------------*/
	...
	if (Node == NULL){
		...
		fprintf(stderr, "LinkedList.c, AddToBackOfLinkedList, Line ...\n");
		fflush(stderr);
	}
...
return;
	...
	if (tmp == NULL){
		fprintf(stderr, "Malloc for ElementStruct FAILED!\n");
		fprintf(stderr, "LinkedList.c AddToBackOfLinkedList, Line ...\n");
		fflush(stderr);
	}	
