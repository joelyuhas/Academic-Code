...
def bstToString( tr ):
   ...
   if tr == None:
       ...
       return "("  + bstToString( tr.left )   + '->'  +  str( tr.value ) + ',' +  bstToString( tr.right ) + ")"
...
def test_bstToString():
    ...
    print( bstToString( exampleTree6 ))
...
def bstSearch( tr, value ):
    ...
    if tr == None:
       ...
       if value == tr.value:
          ...
          w =  bstSearch ( tr.left, value )
          return w
       elif value > tr.value:
          q = bstSearch ( tr.right, value )
          return q
...
def test_bstSearch():
    ...
    print( bstSearch( exampleTree6, 9 ) )
